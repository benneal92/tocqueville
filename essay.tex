...
\title{CLT Philosophy Meetup: Liberalism and Tocqueville}
...
\section{Links}
\href{https://www.c-span.org/program/compiled-program/traveling-tocquevilles-america-video/115967}{Traveling Tocqueville's America}
...
\begin{itemize}
    ...
    \item Established stable republican government without radicalism or terror
\end{itemize}
\subsection{Europe in Tocqueville's Time}
\begin{itemize}
    \item Post-revolutionary France grappling with political instability and the dismantling of the aristocratic order
    \item Central question: Is democracy inevitable, and can it preserve liberty?
    \item French Revolution's legacy: tension between equality and liberty often resulted in chaos or authoritarianism
    \item Fear that equality's advance might produce tyranny of the majority and crush individual freedom
\end{itemize}
\subsection{America in Tocqueville's Time}
\begin{itemize}
...
\begin{itemize}
    \item French political philosopher and historian, born in 1805 to an aristocratic family shortly after the French Revolution
    \item Studied law in Paris (1823–1826) and became an apprentice judge in 1827
    \item Traveled to America (1831–32), England (1833), and Ireland (1835)
    \item Best known for \textit{Democracy in America}, published in two volumes (1835 and 1840)
    \item Elected to the Constituent Assembly in 1848 after two unsuccessful runs for the Chamber of Deputies (1837, 1839)
    \item Retired from politics in 1851 and published \textit{The Old Regime and the Revolution} in 1856
\end{itemize}
...
\begin{itemize}
    ...
    \item Method: blended deductive reasoning from human nature with empirical observation
\end{itemize}
...
\subsection{Equality and Freedom}
\begin{itemize}
...
\textbf{Questions}
\begin{itemize}
    \item \textbf{Do we see evidence today of citizens trading freedom for convenience or security? Where?}
...
\textbf{Questions}
\begin{itemize}
    \item \textbf{How does Tocqueville's view of centralization relate to contemporary debates about federalism and local control?}
    \item \textbf{What role should the federal government play versus state and local governments?}
\end{itemize}
...
\textbf{Questions}
\begin{itemize}
    \item \textbf{How many local institutions or community groups do you actively participate in? Has this changed over time?}
    \item \textbf{If local participation is declining, what fills that space in people's lives—and does it provide the same democratic benefits?}
...
\textbf{Questions}
\begin{itemize}
    \item \textbf{Which of Tocqueville's proposed remedies seem most effective today? Which least?}
